...
function checkAchievements() {
  const ACHIEVEMENT_DEFS = [
    ...
    { id: 'sub_100',           icon: '🎯',  title: 'Sub 100',           check: (s) => s.bestScore !== null && s.bestScore < 100 },
    { id: 'sub_90',            icon: '🔥',  title: 'Sub 90',            check: (s) => s.bestScore !== null && s.bestScore < 90 },
    { id: 'sub_80',            icon: '⚡',  title: 'Sub 80',            check: (s) => s.bestScore !== null && s.bestScore < 80 },
